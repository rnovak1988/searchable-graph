...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post permissions_url, params: { permission: { can_read: @permission.can_read, can_write: @permission.can_write, document_id: @permission.document_id, user_id: @permission.user_id } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { can_read: @permission.can_read, can_write: @permission.can_write, document_id: @permission.document_id, user_id: @permission.user_id } }
